...
ballSize = 1;
numBalls = 64;
ballLife = 200; // Balls live this many iterations
freq = 1; // Explode at most every `freq` frames
time = 0;
previous = 0;
started = false;
...
function setUp() {
    ...
    ctx.fillText('Move your mouse to begin.', width / 2, height / 2);
