...
BugImg.src = "http://s2js.com/img/etc/ladybug.png";// The bug

var melon_x = 0;
var melon_y = 0;
var MelonImg = new Image();
MelonImg.src = "http://s2js.com/img/etc/watermelon2.png";// The melon
...
function ImagesTouching(x1, y1, img1, x2, y2, img2) {
	// detects whether two images are touching
...
function MyKeyDownHandler (MyEvent) { 
	if (MyEvent.keyCode == 37 && bug_x > 0) {bug_x = bug_x-20;} // left
	if (MyEvent.keyCode == 39 && bug_x+BugImg.width < myCanvas.width) {bug_x = bug_x+20;}  // right
...
//myCanvas.width = window.outerWidth - 20; // fill the entire browser width
//myCanvas.width = window.outerWidth - 20;
//myCanvas.height = window.outerHeight - 20;
//myCanvas.height = window.outerHeight - 20; // fill the entire browser height
...
//medium.com/tech-tajawal/modern-frontend-developer-in-2018-4c2072fa2b9c
